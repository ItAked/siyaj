          ...
          <div className="pb-12 text-center md:pb-16">
            ...
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={300}
              >
                إن هذا المشروع ليس مجرد منصة قانونية، بل هو مبادرة تهدف إلى خلق بيئة عمل صحية وآمنة تدعم الممارسين في تقديم أفضل الخدمات للمرضى، مع ضمان حقوقهم القانونية بشكل متكامل وميسر.
              </p>
            </div>
          </div>
        </div>
