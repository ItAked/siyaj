    ...
    return(
        <>
            <section className="my-40 text-right mx-80 max-sm:mx-8" id="contactUs">
                <article className="mb-10 grid gap-y-4 place-items-center text-balance">
                    <h1 className="text-4xl font-bold">تواصل معنا</h1>
                    <p>نسعد باستقبال الآراء و الاقتراحات ونستمع لشكواكم باهتمام. وسنحاول الرد عليكم في أقرب وقت</p>
                </article>
