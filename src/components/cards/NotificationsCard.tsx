...
const NotificationCard = () => {
    ...
    return (
        <>
            <section className="bg-gray-25 border border-gray-300 rounded-xl w-full h-full p-7">
                <h1 className="text-2xl font-medium">الإشعارات</h1>
                ...
                <div className="grid my-11 gap-y-6">
                    { notfications.length > 0 ? notfications.map((notification, index) => (
                        <div className="card w-full bg-base-100 shadow-sm" key={index}>
