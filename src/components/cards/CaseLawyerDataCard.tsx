const CaseLawyerDataCard = ({ lawyerData }) => {
    return(
        <>
            <div className="p-5 border border-gray-200 mt-6 rounded-2xl dark:border-gray-800 lg:p-6">
                <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-x-4">
                        <p className="text-2xl text-gray-800 dark:text-white/90">معلومات المحامي</p>
                    </div>
