...
export default function Hero() {
  return (
    <section className="container mx-auto py-16 flex flex-col-reverse items-center justify-center gap-8 md:py-20 md:flex-col-reverse md:gap-12 lg:flex-row
    lg:items-center lg:justify-between lg:gap-16 lg:py-24 xl:max-w-7xl" id="aboutUs">
      <article className="text-right text-balance text-sky-950 grid w-fit gap-y-4 dark:text-white">
