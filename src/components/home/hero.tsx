    ...
    lg:justify-between lg:gap-16 lg:py-24 xl:max-w-7xl" id="aboutUs">
      <article className="text-right text-balance text-sky-950 grid w-fit gap-y-4">
        ...
        <div className="flex items-center gap-x-3">
          <Link className="btn bg-blue-300 text-white border-none font-medium text-base" href="/practitioner/auth/signup">الدخول كممارس صحي</Link>
          <Link className="btn text-blue-300 border-blue-300 bg-white font-medium text-base" href="/lawyer/auth/signin">الدخول كمحامي</Link>
        </div>
      </article>
