...
const Subscriptions = () => {
  ...
  const getPrice = (subscription: { id?: number; name?: string; description?: string; monthlyPrice: unknown; yearlyPrice: unknown; features?: string[];
    notIncluded?: string[]; popular?: boolean; color?: string; }) => {
