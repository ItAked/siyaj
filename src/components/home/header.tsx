      ...
      <div>
        <div className="relative flex items-center justify-between gap-3 py-8 px-4 md:px-14">
          ...
          <div className="flex items-center gap-x-4">
            <ThemeToggleButton />
            <Link href='/'>
              <img src={Logo.src} alt="logo" className="w-12 h-12 dark:hidden" loading="lazy" />
              <img src='/images/logo/vaadin_scale.png' alt="logo" className="w-12 h-12 dark:block hidden" loading="lazy" />
            </Link>
          </div>
